...
public class Pelicula {
    ...
    public static Comparator<Pelicula> ordenarMayorAMenor = new Comparator<Pelicula>(){
      ...
      public static Comparator<Pelicula> ordenaraAlfabeticamenteTitulos = new Comparator<Pelicula>(){
        @Override
        public int compare(Pelicula p1, Pelicula p2){
            return p1.getTitulo().compareTo(p2.getTitulo());
        }
    };
      public static Comparator<Pelicula> ordenaraAlfabeticamenteDirectores = new Comparator<Pelicula>(){
        @Override
        public int compare(Pelicula p1, Pelicula p2){
